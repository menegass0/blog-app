<script setup>
    ...
    import CardIndexInfo from '../components/cards/CardIndexInfo.vue';
        ...
        <div class="container py-20 px-6 mx-auto " >
            <nav class="flex justify-between mb-20">
                <div class="flex items-center gap-3">
                    <div class="text-center flex items-center justify-center rounded-lg p-3 h-10 w-10 bg-orange-600">
                ...
                <div class="flex gap-3 items-center">
                    ...
                    <Link class="btn bg-orange-600 px-5 py-2 whitespace-nowrap rounded-lg text-white font-semibold">Comece Agora <i class="ms-3 fas fa-arrow-right"></i></Link>
                </div>
            </nav>

            <div class="max-w-4xl mx-auto text-center">
                <h1 class="text-6xl md:text-7xl font-bold mb-6">Sua nova forma de <span>se conectar</span></h1>
